...
class MapperTest {
    ...
    void mapsSoftwareAssignmentDetailsAcrossLicenseEmployeeAndAssignment() {
        ...
        var response = Mapper.toSoftwareAssignmentResponse(assignment);
    ...
    void licenseResponseNeverReportsNegativeRemainingSeats() {
        EmployeeResponse assignedEmployee = Mapper.toEmployeeResponse(employee());

        var response = Mapper.toSoftwareLicenseResponse(
                license(7L, 2, 5),
    ...
    void licenseResponseTreatsNullSeatCountsAsZeroForRemainingCalculation() {
        ...
        var response = Mapper.toSoftwareLicenseResponse(license, List.of());
